        ...
        pickedArr(){
            ...
            if(this.isInitMultiArray){
                return [
                    ...
                    (CHINA_REGIONS[0].childs && CHINA_REGIONS[0].childs[0] && CHINA_REGIONS[0].childs[0].childs) ? CHINA_REGIONS[0].childs[0].childs : []
                ]
            }
    ...
    async created() {
        try {
            ...
            if(CHINA_REGIONS && CHINA_REGIONS.length > 0) {
                ...
                this.districtArr = (CHINA_REGIONS[0].childs && CHINA_REGIONS[0].childs[0] && CHINA_REGIONS[0].childs[0].childs) 
            ...
            try{
                switch(col){
                    case 0:
                        ...
                        that.districtArr = (prov.childs[that.multiIndex[1]] && prov.childs[that.multiIndex[1]].childs) 
